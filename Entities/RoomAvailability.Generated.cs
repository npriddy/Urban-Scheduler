...
{
    /// <summary>
    /// The class representing the dbo.RoomAvailability table.
    /// </summary>
    [System.Data.Linq.Mapping.Table(Name="dbo.RoomAvailability")]
    [System.Runtime.Serialization.DataContract(IsReference = true)]
    [System.ComponentModel.DataAnnotations.ScaffoldTable(true)]
    [System.ComponentModel.DataAnnotations.MetadataType(typeof(Urban.Data.RoomAvailability.Metadata))]
        ...
        : LinqEntityBase, ICloneable 
    {
        ...
        /// <summary>
        /// Initializes the <see cref="RoomAvailability"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoomAvailability"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the Days column value.
        /// </summary>
        [System.Data.Linq.Mapping.Column(Name = "Days", Storage = "_days", DbType = "nvarchar(150)")]
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Column(Name = "StartDate", Storage = "_startDate", DbType = "date NOT NULL", CanBeNull = false)]
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Column(Name = "EndDate", Storage = "_endDate", DbType = "date")]
        ...
        /// <summary>
        /// Gets or sets the StartTime column value.
        /// </summary>
        [System.Data.Linq.Mapping.Column(Name = "StartTime", Storage = "_startTime", DbType = "time NOT NULL", CanBeNull = false)]
        ...
        /// <summary>
        /// Gets or sets the EndTime column value.
        /// </summary>
        [System.Data.Linq.Mapping.Column(Name = "EndTime", Storage = "_endTime", DbType = "time NOT NULL", CanBeNull = false)]
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Association(Name = "Room_RoomAvailability", Storage = "_room", ThisKey = "RoomID", OtherKey = "Id", IsForeignKey = true)]
        ...
        public Room Room
        {
            ...
            set
            {
                ...
                if (previousValue != value || _room.HasLoadedOrAssignedValue == false)
                {
                    ...
                    {
                        _room.Entity = null;
                        previousValue.RoomAvailabilityList.Remove(this);
                    }
                    _room.Entity = value;
                    if (value != null)
                    {
                        value.RoomAvailabilityList.Add(this);
                        _roomID = value.Id;
                    }
                    else
                    {
        ...
        /// <summary>Called when <see cref="Days"/> is changing.</summary>
        /// <param name="value">The new value.</param>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        partial void OnDaysChanging(string value);
        /// <summary>Called after <see cref="Days"/> has Changed.</summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        ...
        /// <summary>Called when <see cref="StartTime"/> is changing.</summary>
        /// <param name="value">The new value.</param>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        partial void OnStartTimeChanging(System.TimeSpan value);
        /// <summary>Called after <see cref="StartTime"/> has Changed.</summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        partial void OnStartTimeChanged();
        /// <summary>Called when <see cref="EndTime"/> is changing.</summary>
        /// <param name="value">The new value.</param>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        partial void OnEndTimeChanging(System.TimeSpan value);
        /// <summary>Called after <see cref="EndTime"/> has Changed.</summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        ...
        /// <summary>
        /// Deserializes an instance of <see cref="RoomAvailability"/> from XML.
        /// </summary>
        /// <param name="xml">The XML string representing a <see cref="RoomAvailability"/> instance.</param>
        /// <returns>An instance of <see cref="RoomAvailability"/> that is deserialized from the XML string.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        ...
        /// <summary>
        /// Deserializes an instance of <see cref="RoomAvailability"/> from a byte array.
        /// </summary>
        /// <param name="buffer">The byte array representing a <see cref="RoomAvailability"/> instance.</param>
        /// <returns>An instance of <see cref="RoomAvailability"/> that is deserialized from the byte array.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public static RoomAvailability FromBinary(byte[] buffer)
        {
            var deserializer = new System.Runtime.Serialization.DataContractSerializer(typeof(RoomAvailability));
        ...
        /// </remarks>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public RoomAvailability Clone()
        {
            return (RoomAvailability)((ICloneable)this).Clone();
        }
        #endregion
