...
{
    /// <summary>
    /// The manager class for Files.
    /// </summary>
    public partial class FilesManager 
        : CodeSmith.Data.EntityManagerBase<UrbanDataManager, Urban.Data.Files>
    {
        /// <summary>
        /// Initializes the <see cref="FilesManager"/> class.
        /// </summary>
        /// <param name="manager">The current manager.</param>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public FilesManager(UrbanDataManager manager)
            : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        protected System.Data.Linq.Table<Urban.Data.Files> Entity
        {
            get { return Manager.Context.Files; }
        }
        ...
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public override Urban.Data.Files GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public Urban.Data.Files GetByKey(int id)
        {
            if (Context.LoadOptions == null) 
                return Query.GetByKey.Invoke(Context, id);
            else
                return Entity.FirstOrDefault(f => f.Id == id);
        }
        ...
        {
            return Entity.Delete(f => f.Id == id);
        }
        ...
        private static partial class Query
        {
            ...
            [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
            internal static readonly Func<Urban.Data.UrbanDataContext, int, Urban.Data.Files> GetByKey = 
                System.Data.Linq.CompiledQuery.Compile(
                    (Urban.Data.UrbanDataContext db, int id) => 
                        db.Files.FirstOrDefault(f => f.Id == id));
